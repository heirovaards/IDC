                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <br />
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{route('update.comment', $comment->id)}}" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    {{method_field('PATCH')}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <textarea name="editor1" class="form-control" placeholder="Page Body">{{$comment->comment}}</textarea>
                                            <input type="hidden" value="{{$comment->userid}}" name="userid" >
                                            <input type="hidden" value="{{$comment->eventid}}" name="eventid">
                                        </div>
                                    </div>
