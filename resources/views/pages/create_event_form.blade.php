                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <br />
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{route('post.event')}}" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" name="eventname" value="{{old('eventname')}}" >
                                            <input type="hidden" id="first-name" required="required" class="form-control col-md-7 col-xs-12" name="userid" value="{{Auth::user()->id}}">
                                        </div>
                                    </div>
                                            ...
                                            <div class="control-group">
                                                <div class="controls">
                                                    <div class="{{--xdisplay_inputx form-group has-feedback--}}">
                                                        <input type="date" class="form-control t"  placeholder="Event Date" name="eventdate" value="{{old('eventdate')}}" >
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @endif
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text"  name="province" required="required" class="form-control col-md-7 col-xs-12" value="{{old('province')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" required="required" class="form-control col-md-7 col-xs-12" name="city" value="{{old('city')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @endif
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text"  required="required" class="form-control col-md-7 col-xs-12" name="district" value="{{old('district')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @endif
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" required="required" class="form-control col-md-7 col-xs-12" name="address" value="{{old('address')}}">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Event poster <span class="required">*</span>
                                        </label>
